...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="3.0"
  ...
  <!-- Suppress TEI note placeholders with the specific text used in the source -->
  <xsl:template match="tei:note[normalize-space(.) = 'Aici va sta textul în medio-bulgară']"/>
